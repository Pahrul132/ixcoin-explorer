...
function Sidebar() {
  const links = [
    ...
    { href: "/network", icon: "🌐", label: "Network Info" },
  ];
      ...
      <div className="p-4 border-t border-border">
        <div className="rounded-lg border border-orange-500/20 bg-orange-500/5 p-3">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs text-orange-400 font-semibold">LIVE · MAINNET</p>
          </div>
          ...
          <p className="text-xs text-muted-foreground">Block Time: ~5 menit</p>
        </div>
      </div>
    </aside>
  );
      ...
      <Route>
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <Link href="/" className="text-orange-400 hover:text-orange-300 text-sm">← Kembali ke Dashboard</Link>
          </div>
        </div>
      </Route>
    </Switch>
